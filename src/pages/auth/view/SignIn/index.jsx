                ...
                >
                    ...
                    <div className="w-100 text-white px-5">
                        ...
                        <div className="text-large font-weight-light">
                            ...
                            elit.Vestibulum vehicula ex eu gravida
                            faucibus.Suspendisse viverra pharetra purus.Proin
                            fringilla ac lorem at sagittis.Proin tincidunt dui
                            et nunc ultricies dignissim.{' '}
                        </div>{' '}
                    </div>{' '}
                    {/* [ Text ] End */}{' '}
                </div>{' '}
                {/* [ Side container ] End */} {/* [ Form container ] Start */}{' '}
